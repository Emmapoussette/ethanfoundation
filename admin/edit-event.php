...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Ethan-Foundation| Update Event</title>
...
category,category.id as catid,events.RaisesAmount as raises, events.RestAmount as rest from events left join 
category on category.id=events.CategoryId where 
events.id='$eventid' and events.Is_Active=1 ");
