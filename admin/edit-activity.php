...
<textarea class="summernote" name="postdescription" required><?php echo htmlentities($row['ActivityDetails']);?></textarea>
</div>
</div>
</div>
...
<img src="eventimages/<?php echo htmlentities($row['ActivityImage']);?>" width="300"/>
<br />
<a href="change-image.php?eid=<?php echo htmlentities($row['activityid']);?>">Update Image</a>
</div>
</div>
</div>
