...
$usertype='0';
$query=mysqli_query($con,"insert into admin(AdminUserName,AdminEmailId,AdminPassword,userType ) values('$username','$email','$password','$usertype')");
if($query){
...
<html lang="en">
    <head>
        ...
        <title>Ethan-Foundation | Add Subadmin</title>
