...
$sql =mysqli_query($conn,"SELECT AdminUserName,AdminEmailId,AdminPassword,userType FROM admin WHERE (AdminUserName='$uname' && AdminPassword='$password')");
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Ethan-Foundation | Admin Panel</title>
...
<a href=""><i class="mdi mdi-home"></i> Ethan-Admin</a>
                                </div>
                            </div>
                            <!-- end card-box-->
