...
<html>
	...
	<body>
        ...
        $img_dir = $working_dir . "/eventimages/";
          ...
          <img src="admin/events/<?php  echo htmlentities($row['EventImage']) ?>" class="img-responsive" /><br />
          <img src="<?php  echo htmlentities($row['eventimages']) ?>" class="img-responsive" /><br />
          <img src="<?php echo $row['EventImage']; ?>" class="img-responsive" /><br />
          <img src="admin/events/<?php echo  $img_dir ?>">
