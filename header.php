                ...
                <div class="col-lg-3 col-md-6 folouws">
                    ...
                    <ul class="ulright">
                       <li> <small>Folow Us </small>:</li>
                        <!--<li>
                        <a href="http://www.facebook.com/follow.php?u=<?php echo $currenturl;?>" target="_blank">  <i class="fab fa-facebook-square"></i></a>
                        </li>-->
                        <li>
                        ...
                        <li>
                        <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $currenturl;?>" target="_blank"> <i class="fab fa-linkedin"></i></a>
                        </li>
                    </ul>
                </div>
